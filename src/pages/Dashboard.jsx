...
const Dashboard = () => {
  ...
  const departmentCounts = departments.map((department) => ({
    name: department,
    count: employees.filter((employee) => employee.department === department)
      .length,
  }));
    ...
    <div className="dashboard">
      ...
      <div className="dashboard-stats">
        <div className="stat-card">
          ...
          <p className="stat-description">Employees in organization</p>
        </div>
        ...
        <div className="stat-card">
          ...
          <p className="stat-description">Currently on leave</p>
        </div>
      </div>
        ...
        <div className="dashboard-panel">
          <div className="panel-header">
            <div>
              ...
              <p>Current employee statistics</p>
            </div>
          </div>
      ...
      <div className="dashboard-panel recent-employees">
        ...
        {recentEmployees.length === 0 ? (
          <div className="empty-state">
            ...
            <p>Add your first employee to see them here.</p>
          </div>
        ) : (
          <div className="recent-employee-list">
            {recentEmployees.map((employee) => (
              <div className="recent-employee" key={employee._id}>
